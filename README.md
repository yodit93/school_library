...
Clone this [repository](https://github.com/yodit93/school_library.git) to your desired folder.
...
Feel free to check the [issues page](https://github.com/yodit93/school_library/issues)
